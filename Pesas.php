...
<html lang="en">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active" style="height: 100vh">
      <img src="images/pesas1.jpg" alt="Los Angeles" width="1100" height="500">
      <div class="carousel-caption d-none d-md-block">
    <h5>ACERCA DE LAS PESAS</h5>
  </div>
    </div>
    <div class="carousel-item" style="height: 100vh">
      <img src="images/pesas4.png" alt="Chicago" width="1100" height="500">
    </div>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-12 col-lg-5 mb-5 mb-lg-0">
            <h2 class="mb-3 text-uppercase">Gana masa muscular entrenando con <strong class="text-black font-weight-bold">pesas</strong></h2>
          ...
          <div class="col-md-12 col-lg-6 ml-auto">
            <img src="images/pesas2.jpg" alt="Image" class="img-fluid">
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-12 col-lg-5 mb-5 mb-lg-0 order-2">
            <h2 class="mb-3 text-uppercase">Tonifica y define tus <strong class="text-black font-weight-bold">musuclos</strong></h2>
            <p class="lead">Lorem ipsum dolor sit amet consectetur adipisicing elit. Eaque accusamus, rerum illo facilis reiciendis.</p>
            <p class="mb-4">Iste aut dolorem veritatis saepe nesciunt distinctio voluptas sapiente sunt perspiciatis autem minima, iure provident. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Vero, quas.</p>
            <ul class="site-block-check">
              <li>Lorem ipsum dolor sit amet, consectetur adipisicing.</li>
          ...
          <div class="col-md-12 col-lg-6 mr-auto order-1">
            <img src="images/pesas3.jpeg" alt="Image" class="img-fluid">
          </div>
        </div>
      </div>
    </div>
