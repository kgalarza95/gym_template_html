        ...
        <div id="demo" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active" style="height: 100vh">
                    <img src="images/Yoga.jpg" alt="Los Angeles" width="1100" height="500">
                    <div class="carousel-caption d-none d-md-block">
                        <h5>ACERCA DEL YOGA</h5>
                    </div>
                </div>
                <div class="carousel-item" style="height: 100vh">
                    <img src="images/yoga2.jpg" alt="Chicago" width="1100" height="500">
                </div>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-12 col-lg-5 mb-5 mb-lg-0">
                        <h2 class="mb-3 text-uppercase">Conectate con tu <strong class="text-black font-weight-bold">mente y espiritu</strong></h2>
                    ...
                    <div class="col-md-12 col-lg-6 ml-auto">
                        <img src="images/Serv2.jpg" alt="Image" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-12 col-lg-5 mb-5 mb-lg-0 order-2">
                        <h2 class="mb-3 text-uppercase">Armoniza tu <strong class="text-black font-weight-bold">cuerpo</strong></h2>
                        <p class="lead">Lorem ipsum dolor sit amet consectetur adipisicing elit. Eaque accusamus, rerum illo facilis reiciendis.</p>
                        <p class="mb-4">Iste aut dolorem veritatis saepe nesciunt distinctio voluptas sapiente sunt perspiciatis autem minima, iure provident. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Vero, quas.</p>
                        <ul class="site-block-check">
                            <li>Lorem ipsum dolor sit amet, consectetur adipisicing.</li>
                    ...
                    <div class="col-md-12 col-lg-6 mr-auto order-1">
                        <img src="images/yoga1.png" alt="Image" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
